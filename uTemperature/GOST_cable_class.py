...
print(cable.calc_i_max_a(120,100))
print(59.363596930182304)
print(cable.calc_t_max_cable_c(100, 59.363596930182304))
print(120)

print(cable.calc_t_max_cable_c(100, cable.calc_i_max_a(120, 100)))