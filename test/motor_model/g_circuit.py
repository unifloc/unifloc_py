...
def calc_resistances(nom_power__W, nom_voltage__V, nom_slip, nom_efficient,
    ...
    #рекомендованное значение(отношение электромагнитного момента к вращающемуся)
...
def calc_idle(nom_voltage__V, nom_slip, nom_efficient, nom_cos,
...
def calc_g_circuit(slip, nom_power__W, nom_voltage__V, nom_slip, nom_efficient,
                   nom_cos, motor_lamda, frequency__Hz, voltage__V,
                   r_1__Om, r_2__Om, x_k__Om):
    """
    ...
    M0__Nm = M_nom__Nm * (motor_lamda - 1)
    ...
    return M__Nm,  cos_fi, efficient, I1__A
