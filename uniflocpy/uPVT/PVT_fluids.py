...
"""
# TODO cделать калибровку всех свойств
# TODO сделать диаграмму рассогласованности
# TODO сделать единый класс, в котором можно выбрать любой пресет корреляций
#      набор корреляций передавать через структуру 1 раз, стартовый пресет Стендинга
#      при этом поток данных не будет прямо связан с выбором коореляций
