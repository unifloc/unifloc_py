...
class TestMotor(unittest.TestCase):
    def test_calc_resistances(self):
        ...
        self.assertAlmostEqual(sum(calc_resistances(nom_power__W=nom_power__kW*1e3,
    ...
    def test_calc_idle(self):
        ...
        self.assertAlmostEqual(sum(calc_idle(nom_voltage__V, nom_slip, nom_efficient, nom_cos, r_1__Om,
    ...
    def test_calc_g_circuit(self):
        ...
        frequency__Hz = 50
        moments_division = 1.13
        self.assertAlmostEqual(sum(calc_g_circuit(slip=nom_slip,
    ...
    def test_motor_data_loading(self):
        ...
        frequency__Hz = 50
        moments_division = 1.13
        self.assertAlmostEqual(sum(motor_data_loading(motor_power__kW*1e3,
